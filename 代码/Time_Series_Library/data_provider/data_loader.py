...
class UEAloader(Dataset):
    ...
    def _resolve_ts_path(self, root_path, dataset_name, flag="train"):
        fname = f"{dataset_name}_{flag.upper()}.ts"

        # 🌟 我们的外科手术：强制让它组合出绝对正确的本地路径并返回，彻底断绝联网的念头！
        import os
        local_path = os.path.join(root_path, dataset_name, fname)
        return local_path
